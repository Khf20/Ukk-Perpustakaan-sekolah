                    ...
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image">
                                <img src="assets/img/login-biru.png" style="max-height: 490px" alt="">
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form href="/register/store" method="post" class="user">
                                        @csrf
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                id="exampleInputPassword" placeholder="Ulangi Password" name="password_confirm">
                                        </div>
